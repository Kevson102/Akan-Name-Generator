function akanGenerator (){
  ...
  var dayOfWeek = (date +Math.floor(2.6*month-0.2)-2*century+year+Math.floor(year/4)+Math.floor(century/4)) % 7;
...
//   if (gender === "Male"){
//     document.getElementById('output').innerHTML = "Since you are "+ gender+" and you were born on "+weekDays[dayOfWeek+2]+", your Akan name is "+maleNames[dayOfWeek-1]+".";
//   } else {
//     document.getElementById('output').innerHTML = "Since you are "+ gender+" and you were born on "+weekDays[dayOfWeek-1]+", your Akan name is "+femaleNames[dayOfWeek-1]+".";
//   }
}
akanGenerator();
